...
def plan_rrt_star(start_m, goal_m, map_path, meters_per_pixel=0.005, step_size_m=0.1, search_radius_m=1, robot_radius_m=0.0, goal_tolerance_m=1, max_iterations=5000):
